-- Active: 1770471809351@@127.0.0.1@3306@contoso
-- Query & Sub-query
----------------------------
...
INSERT INTO employee (emp_id, first_name, last_name, birth_day, gender, salary, super_id, branch_id)
...
SELECT count(*), client_id from works_with GROUP BY client_id;
...
-- Which employee is the manager of which branch?
...
-- step 2
SELECT emp_id, employee.first_name, employee.last_name
FROM employee
...
select * from employee;
 ...
 WHERE client.branch_id = (SELECT branch.branch_id
                           ...
                           WHERE branch.mgr_id = (SELECT employee.emp_id
                                                  FROM employee
                                                  WHERE employee.first_name = 'Michael' AND employee.last_name = 'Scott' LIMIT 1));
